...
async function setMelody2() {
    var sampleMelodyA = await mm.urlToNoteSequence(midiUrl2);
    var sampleMelodyB = mm.sequences.quantizeNoteSequence(sampleMelodyA, 4);
    sampleMelody2 = mm.sequences.trim(sampleMelodyB, 0, 32, true);
    //console.log('melody updated');
};
...
function previewFile2() {
    ...
    console.log(file2.name +  " is " + file2.size/1024 + "kb");
    document.getElementById('loadedFile2').innerHTML = file2.name;

    reader2.addEventListener("load", function () {
        //var playFile = new mm.midiToSequenceProto(reader.result);
        //new mm.Player().start(playFile);
        midiUrl2 = reader2.result;
        setMelody2();
    }, false);
